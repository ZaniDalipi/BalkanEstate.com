/**
 * HowItWorks Page Icons
 * Inline SVG icons used throughout the How It Works page
 */
...
export const CrownIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 19h14M5 19l2-12 5 5 5-5 2 12M5 19h14" />
  </svg>
);
