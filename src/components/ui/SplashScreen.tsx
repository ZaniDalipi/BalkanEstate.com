...
/*                                                                     */
/*  No `invert` and no `mix-blend-difference`: the aurora gradient is   */
/*  blue/indigo/violet, and inverting it turns those hues gold — which  */
/*  is what WebKit showed, because `html.is-webkit` (index.css) forces  */
/*  this pseudo-element to `mix-blend-mode: normal`, so nothing was     */
/*  left to cancel the inversion. Painting the gradient as authored     */
/*  keeps it blue on every engine.                                     */
/* ------------------------------------------------------------------ */
