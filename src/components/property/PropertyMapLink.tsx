...
const MapLoadingFallback: React.FC = () => (
  <div className="bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-xl animate-pulse flex items-center justify-center h-[500px]">
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-neutral-200 overflow-hidden">
      ...
      {hasValidCoordinates ? (
        ...
        <div className="h-[500px] bg-neutral-100 flex items-center justify-center">
