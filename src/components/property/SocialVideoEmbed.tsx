      ...
      <div ref={containerRef} className="flex justify-center bg-neutral-50 p-4">
        ...
        {embedFailed && (
          <div className="text-center p-8">
            ...
            >
              {t('property:socialVideo.openIn', { platform: platform === 'tiktok' ? 'TikTok' : 'Instagram', defaultValue: `Open in ${platform === 'tiktok' ? 'TikTok' : 'Instagram'}` })}
        ...
        {/* Instagram Embed - Using official blockquote method like TikTok */}
        {platform === 'instagram' && !embedFailed && (
          <div className="w-full flex justify-center">
            <blockquote
              className="instagram-media"
              data-instgrm-captioned
              data-instgrm-permalink={`${instagramPermalink}?utm_source=ig_embed`}
            ...
            >
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  ...
                  <span className="text-neutral-600 text-sm">Loading Instagram video...</span>
                </div>
              </a>
            </blockquote>
          </div>
