...
export const PropertyGallery: React.FC<PropertyGalleryProps> = ({
  ...
  useEffect(() => {
    if (hasVideo && !videoEnded) {
      setViewMode('video');
      // Auto-transition to photos after 10 seconds if user hasn't interacted
      ...
      <div className="relative w-full h-[200px] xs:h-[250px] sm:h-[350px] md:h-[400px] lg:h-[450px] landscape:h-[50vh] landscape:min-h-[200px] bg-neutral-200">
        {viewMode === 'photos' ? (
          ...
          <div className="relative w-full h-full bg-black flex items-center justify-center overflow-hidden">
            {/* Immersive preview for vertical videos (TikTok, Instagram, Facebook) - opens in new tab for best experience */}
            {['tiktok', 'instagram', 'facebook'].includes(videoInfo.platform) ? (
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center px-6">
                  ...
                  <div className="mb-6">
                    {videoInfo.platform === 'instagram' && (
                      <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center shadow-2xl">
                    ...
                    {videoInfo.platform === 'tiktok' && (
                      <div className="w-20 h-20 rounded-2xl bg-black flex items-center justify-center shadow-2xl ring-2 ring-white/20">
                        <svg className="w-12 h-12 text-white" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {videoInfo.platform === 'facebook' && (
                      <div className="w-20 h-20 rounded-2xl bg-[#1877F2] flex items-center justify-center shadow-2xl">
                        <svg className="w-12 h-12 text-white" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <h3 className="text-white text-xl font-bold mb-2">
                    {t('property:gallery.propertyVideo', 'Property Video Tour')}
                  </h3>
                  <p className="text-white/70 text-sm mb-6 max-w-xs">
                    {t('property:gallery.watchOnPlatform', 'Watch the full video with sound on {{platform}}', { platform: videoInfo.platform.charAt(0).toUpperCase() + videoInfo.platform.slice(1) })}
                  </p>
                  ...
                  <a
                    ...
                    className="group flex items-center gap-3 bg-white text-neutral-900 font-semibold px-8 py-4 rounded-full hover:bg-white/90 hover:scale-105 transition-all shadow-2xl"
                  >
                    <div className="w-10 h-10 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                      <svg className="w-5 h-5 text-white ml-0.5" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M8 5v14l11-7z"/>
                      </svg>
                    </div>
                    <span>{t('property:gallery.watchVideo', 'Watch Video')}</span>
              ...
              /* Default horizontal format for YouTube/Vimeo - these embed nicely */
              <iframe
