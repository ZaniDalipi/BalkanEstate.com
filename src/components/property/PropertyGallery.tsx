      ...
      <div className="relative w-full h-[200px] xs:h-[250px] sm:h-[350px] md:h-[400px] lg:h-[450px] landscape:h-[50vh] landscape:min-h-[200px] bg-neutral-200">
        {viewMode === 'photos' ? (
          ...
          <div className="relative w-full h-full bg-black flex items-center justify-center overflow-hidden">
            {/* Immersive HDR mode for vertical videos (TikTok, Instagram, Facebook) */}
            {['tiktok', 'instagram', 'facebook'].includes(videoInfo.platform) ? (
              <>
                ...
                {/* Centered 9:16 video container */}
                <div className="relative z-10 h-full flex items-center justify-center py-2 sm:py-4">
                  <div
                    className="relative bg-black rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10"
                    style={{
                      aspectRatio: '9/16',
                      height: 'calc(100% - 16px)',
                      maxHeight: '100%',
                      maxWidth: 'calc((100vh - 32px) * 9 / 16)',
                    }}
                  >
                    <iframe
                      ...
                      style={{
                        transform: 'scale(1.01)', // Slight scale to hide any iframe borders
                      }}
                      scrolling="no"
                      allowFullScreen
                    ...
                    />
                    {/* Fallback overlay with watch button if embed fails */}
                    <a
                      href={property.tourUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 bg-white/90 backdrop-blur-sm text-neutral-900 font-semibold px-4 py-2 rounded-full hover:bg-white transition-all shadow-lg text-sm opacity-0 hover:opacity-100"
                    >
