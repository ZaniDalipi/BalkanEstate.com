...
export const OrganizationSchema: React.FC<OrganizationSchemaProps> = ({
  ...
  description = 'BalkanEstateAI is the leading AI-powered real estate platform covering all 10 Balkan countries. Find property for sale in Montenegro, Albania, Kosovo, North Macedonia, Serbia, Croatia, Bosnia, Bulgaria, Romania, and Greece. AI-powered search, valuations, and 10 languages.',
