...
export function buildPreviewProperty(
    ...
    return {
        ...
        priceType: listingData.priceType || undefined,
        pricePerSqm: listingData.pricePerSqm > 0 ? listingData.pricePerSqm : undefined,
    ...
    useEffect(() => {
        if (propertyToEdit) {
            ...
            setListingData({
                ...
                priceType: propertyToEdit.priceType ?? (propertyToEdit.isNegotiable ? 'negotiable' : 'fixed'),
                pricePerSqm: propertyToEdit.pricePerSqm ?? 0,
