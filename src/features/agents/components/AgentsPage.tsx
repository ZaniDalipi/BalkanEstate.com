  ...
  return (
    <div className="bg-neutral-50 min-h-screen flex flex-col">
      ...
      <HeroSearchSection
        ...
        searchPlaceholder={t('agents:search.placeholders.name', 'Search by name, city, country, or specialty...')}
        ...
        stats={[
          ...
          { icon: 'users', count: agents.length, label: t('agents:stats.verifiedAgents', 'Expert Agents'), color: 'green' },
          { icon: 'home', count: totalActiveListings, label: t('agents:agencies.listedProperties', 'Listed Properties'), color: 'purple' }
        ]}
