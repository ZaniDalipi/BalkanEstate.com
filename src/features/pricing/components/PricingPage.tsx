      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-16">
        ...
        {!loading && !error && activeTab === 'seller' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto items-stretch">
            ...
            {proYearlyProduct && (
              <div className="relative rounded-3xl p-6 sm:p-8 flex flex-col bg-gradient-to-br from-emerald-50 via-white to-cyan-50 border-2 border-emerald-400 shadow-xl lg:-translate-y-4 order-1 lg:order-1">
                {/* Badge */}
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <span className="inline-flex items-center gap-1.5 bg-gradient-to-r from-red-500 to-rose-600 text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg">
                ...
                <ul className="mt-6 space-y-3 flex-grow">
                  {proYearlyProduct.features?.slice(0, 6).map((feature, index) => (
            ...
            {/* Pro Monthly */}
            {proMonthlyProduct && (
              <div className="relative rounded-3xl p-6 sm:p-8 flex flex-col bg-white border border-gray-200 shadow-lg order-2 lg:order-2">
                ...
                {/* Features */}
                <ul className="mt-6 space-y-3 flex-grow">
                  {proMonthlyProduct.features?.slice(0, 5).map((feature, index) => (
                    <li key={index} className="flex items-start gap-3">
            ...
            {enterpriseProduct && (
              <div className="relative rounded-3xl p-6 sm:p-8 flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white shadow-2xl order-3 lg:order-3 overflow-hidden">
                {/* Decorative elements */}
                ...
                <div className="text-center pt-4 relative z-10">
                  ...
                  <p className="mt-2 text-sm text-gray-400">{enterpriseProduct.description || 'Complete agency solution'}</p>
                  <div className="mt-6">
                ...
                <ul className="mt-6 space-y-3 flex-grow relative z-10">
                  {enterpriseProduct.features?.slice(0, 6).map((feature, index) => (
                    <li key={index} className="flex items-start gap-3">
