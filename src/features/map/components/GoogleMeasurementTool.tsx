...
import { Polyline, Polygon, Marker, OverlayView } from '@react-google-maps/api';
      ...
      {points.length > 1 && (
        isPolygonClosed ? (
          ...
          <>
            ...
            {points.length >= 3 && (
              <Polyline
                path={[pathCoords[pathCoords.length - 1], pathCoords[0]]}
                options={{
                  strokeColor: '#10B981',
                  strokeWeight: 2,
                  strokeOpacity: 0.5,
      ...
      {points.map((point, index) => (
        <Marker
          ...
          icon={{
            ...
            scale: index === 0 && points.length >= 3 && !isPolygonClosed ? 10 : 7,
            fillColor: index === 0 && points.length >= 3 && !isPolygonClosed ? '#10B981' : '#0252CD',
            fillOpacity: 1,
            strokeColor: '#ffffff',
            strokeWeight: 2,
          }}
          onClick={index === 0 && points.length >= 3 && !isPolygonClosed ? handleClosePolygon : undefined}
