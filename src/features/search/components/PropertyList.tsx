...
const FilterControls: React.FC<Omit<PropertyListProps, 'properties' | 'showList' | 'aiChatHistory' | 'onAiChatHistoryChange'>> = ({
    ...
    return (
         <div className="space-y-4">
            ...
            {/* By Negotiation Filter */}
            <button
                type="button"
                onClick={() => onFilterChange('isNegotiable', filters.isNegotiable === true ? null : true)}
            ...
            >
                ...
                {t('search:filters.byNegotiation', 'By Negotiation')}
            </button>
