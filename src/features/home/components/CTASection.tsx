...
const CTASection: React.FC<CTASectionProps> = ({ onListProperty, onJoinAsAgent }) => {
  ...
  return (
    <section className="py-12 sm:py-16 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3" />
      <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-indigo-500/8 rounded-full blur-[80px] translate-y-1/3 -translate-x-1/4" />
