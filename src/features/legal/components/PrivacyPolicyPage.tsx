        ...
        <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1 mb-4 ml-4">
              ...
              <li>{t('legal:privacy.collect.personal.payment', 'Payment information (processed securely via our payment processor)')}</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              ...
              <li><strong>{t('legal:privacy.share.providers', 'Service Providers:')}</strong> {t('legal:privacy.share.providersDesc', 'We work with third parties for payment processing, email services, and analytics.')}</li>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-gray-50 rounded-lg p-4">
                <h4 className="font-semibold text-gray-800 mb-1">{t('legal:privacy.thirdParty.paymentTitle', 'Payment Processor')}</h4>
