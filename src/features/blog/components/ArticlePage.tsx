...
const ShareButton: React.FC<{ href?: string; onClick?: () => void; label: string; children: React.ReactNode; copied?: boolean }> = ({
  ...
  const cls = `flex items-center gap-1.5 px-3 py-2 rounded-xl text-slate-600 hover:text-slate-900 bg-white border border-neutral-200 hover:border-neutral-300 hover:shadow-md transition-all duration-200 ${copied ? 'border-emerald-400 text-emerald-700' : ''}`;
  if (href) {
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 py-5 border-t border-b border-neutral-100">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <ShareButton onClick={copyLink} label={copied ? 'Copied!' : 'Copy link'} copied={copied}>
        ...
        <div className="border-t border-neutral-100 py-10 bg-slate-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
              <div>
                <p className="text-sm font-semibold text-slate-700 mb-2">Share this article</p>
