...
import { useUpdateBusinessListing, useUploadBusinessLogo } from '../hooks';
...
const EditBusinessListingForm: React.FC<EditBusinessListingFormProps> = ({ listing, onBack, onSuccess }) => {
  ...
  }, [formData, listingType, lat, lng, logoFile, isActive, listing.id, updateListing, uploadLogo, onSuccess, t, clearErrors, setValidationError]);
