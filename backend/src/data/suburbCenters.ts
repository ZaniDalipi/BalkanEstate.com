...
export const SUBURB_CENTERS: Record<string, SuburbCenterEntry[]> = {
  ...
  Iasi: [
    { name: 'Center', center: [47.157, 27.590], radiusKm: 1.0 },
    { name: 'Copou', center: [47.172, 27.573], radiusKm: 1.2 },
    { name: 'Tatarasi', center: [47.150, 27.610], radiusKm: 1.3 },
    { name: 'Pacurari', center: [47.163, 27.550], radiusKm: 1.2 },
    { name: 'Nicolina', center: [47.138, 27.600], radiusKm: 1.5 },
  ],
  Constanta: [
    { name: 'City Center', center: [44.175, 28.649], radiusKm: 0.9 },
    { name: 'Tomis Nord', center: [44.188, 28.635], radiusKm: 1.2 },
    { name: 'Faleza Nord', center: [44.182, 28.660], radiusKm: 1.0 },
    { name: 'Vyala', center: [44.165, 28.638], radiusKm: 1.3 },
    { name: 'Mamaia', center: [44.250, 28.638], radiusKm: 2.0 },
  ],
  Galati: [
    { name: 'Center', center: [45.435, 28.050], radiusKm: 0.9 },
    { name: 'Micro 13', center: [45.445, 28.040], radiusKm: 1.2 },
    { name: 'Micro 17', center: [45.425, 28.055], radiusKm: 1.2 },
    { name: 'Tiglina', center: [45.440, 28.065], radiusKm: 1.3 },
    { name: 'Mazepa', center: [45.418, 28.044], radiusKm: 1.2 },
  ],
  Craiova: [
    { name: 'Center', center: [44.316, 23.800], radiusKm: 0.9 },
    { name: 'Craiovita Noua', center: [44.328, 23.788], radiusKm: 1.3 },
    { name: 'Brazda lui Novac', center: [44.308, 23.820], radiusKm: 1.4 },
    { name: '1 Mai', center: [44.325, 23.812], radiusKm: 1.2 },
    { name: 'Romanesti', center: [44.302, 23.794], radiusKm: 1.3 },
  ],
  Ploiesti: [
    { name: 'Center', center: [44.944, 26.022], radiusKm: 0.9 },
    { name: 'Malu Rosu', center: [44.955, 26.010], radiusKm: 1.2 },
    { name: 'Enachita Vacarescu', center: [44.935, 26.032], radiusKm: 1.2 },
    { name: 'Mitica Apostol', center: [44.948, 26.038], radiusKm: 1.3 },
    { name: 'Rafov', center: [44.962, 26.028], radiusKm: 1.4 },
  ],
  Oradea: [
    { name: 'City Center', center: [47.063, 21.921], radiusKm: 0.9 },
    { name: 'Rogerius', center: [47.074, 21.928], radiusKm: 1.2 },
    { name: 'Nufarul', center: [47.058, 21.908], radiusKm: 1.2 },
    { name: 'Europa', center: [47.050, 21.935], radiusKm: 1.3 },
    { name: 'Iosia', center: [47.070, 21.905], radiusKm: 1.3 },
  ],
  Volos: [
    { name: 'City Center', center: [39.360, 22.942], radiusKm: 0.9 },
    { name: 'Nea Ionia', center: [39.370, 22.952], radiusKm: 1.2 },
    { name: 'Agios Konstantinos', center: [39.350, 22.930], radiusKm: 1.0 },
    { name: 'Ano Volos', center: [39.365, 22.960], radiusKm: 1.3 },
    { name: 'Portaria', center: [39.380, 22.970], radiusKm: 1.5 },
  ],
  Larissa: [
    { name: 'Center', center: [39.637, 22.419], radiusKm: 0.9 },
    { name: 'Nea Smyrni', center: [39.648, 22.408], radiusKm: 1.2 },
    { name: 'Mezourlo', center: [39.625, 22.430], radiusKm: 1.3 },
    { name: 'Neapoli', center: [39.643, 22.432], radiusKm: 1.2 },
    { name: 'Anthoupoli', center: [39.655, 22.425], radiusKm: 1.4 },
  ],
  Ioannina: [
    { name: 'City Center', center: [39.665, 20.853], radiusKm: 0.9 },
    { name: 'Exochi', center: [39.673, 20.864], radiusKm: 1.2 },
    { name: 'Perama', center: [39.656, 20.842], radiusKm: 1.2 },
    { name: 'Anatoli', center: [39.660, 20.870], radiusKm: 1.3 },
    { name: 'Neokaisareia', center: [39.680, 20.848], radiusKm: 1.4 },
  ],
  Kavala: [
    { name: 'City Center', center: [40.939, 24.402], radiusKm: 0.9 },
    { name: 'Kalamitsa', center: [40.948, 24.390], radiusKm: 1.2 },
    { name: 'Agios Loukas', center: [40.930, 24.412], radiusKm: 1.2 },
    { name: 'Agia Varvara', center: [40.935, 24.418], radiusKm: 1.3 },
    { name: 'Tosca', center: [40.944, 24.415], radiusKm: 1.3 },
  ],
  Chania: [
    { name: 'Old Town', center: [35.513, 24.018], radiusKm: 0.7 },
    { name: 'Nea Chora', center: [35.518, 24.008], radiusKm: 0.9 },
    { name: 'Koum Kapi', center: [35.508, 24.025], radiusKm: 1.0 },
    { name: 'Halepa', center: [35.515, 24.035], radiusKm: 1.2 },
    { name: 'Agios Matthaios', center: [35.522, 24.043], radiusKm: 1.3 },
  ],
  Rhodes: [
    { name: 'Old Town', center: [36.445, 28.226], radiusKm: 0.7 },
    { name: 'Neohori', center: [36.452, 28.218], radiusKm: 1.0 },
    { name: 'Ixia', center: [36.440, 28.210], radiusKm: 1.2 },
    { name: 'Trianda', center: [36.430, 28.195], radiusKm: 1.5 },
    { name: 'Lindos Area', center: [36.091, 28.085], radiusKm: 1.5 },
  ],
  'Stara Zagora': [
    { name: 'Center', center: [42.425, 25.637], radiusKm: 0.9 },
    { name: 'Zagorski', center: [42.434, 25.648], radiusKm: 1.2 },
    { name: 'Ayazmo', center: [42.418, 25.625], radiusKm: 1.3 },
    { name: 'Kamenitsa', center: [42.430, 25.658], radiusKm: 1.2 },
    { name: 'Industralen', center: [42.442, 25.630], radiusKm: 1.4 },
  ],
  Pleven: [
    { name: 'Center', center: [43.415, 24.618], radiusKm: 0.9 },
    { name: 'Storgozia', center: [43.425, 24.605], radiusKm: 1.2 },
    { name: 'Kailaka', center: [43.405, 24.628], radiusKm: 1.3 },
    { name: 'Dружba', center: [43.420, 24.630], radiusKm: 1.2 },
    { name: 'Skobelevo', center: [43.408, 24.610], radiusKm: 1.3 },
  ],
  Ruse: [
    { name: 'Center', center: [43.848, 25.954], radiusKm: 0.9 },
    { name: 'Zdravets', center: [43.858, 25.944], radiusKm: 1.2 },
    { name: 'Druzhba', center: [43.840, 25.965], radiusKm: 1.2 },
    { name: 'Rodina', center: [43.852, 25.967], radiusKm: 1.3 },
    { name: 'Yuzhen', center: [43.838, 25.948], radiusKm: 1.3 },
  ],
  Sliven: [
    { name: 'Center', center: [42.685, 26.325], radiusKm: 0.9 },
    { name: 'Kluch', center: [42.694, 26.314], radiusKm: 1.2 },
    { name: 'Industrialen', center: [42.678, 26.335], radiusKm: 1.3 },
    { name: 'Nadezhda', center: [42.690, 26.338], radiusKm: 1.2 },
    { name: 'Sini Kamani', center: [42.700, 26.320], radiusKm: 1.4 },
  ],
  Dobrich: [
    { name: 'Center', center: [43.572, 27.830], radiusKm: 0.9 },
    { name: 'Druzhba', center: [43.582, 27.818], radiusKm: 1.2 },
    { name: 'Industrialen', center: [43.562, 27.840], radiusKm: 1.3 },
    { name: 'Svoboda', center: [43.575, 27.843], radiusKm: 1.2 },
    { name: 'Riltsi', center: [43.565, 27.820], radiusKm: 1.3 },
  ],
};
