...
const PRODUCTS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Special agency page with banner and logo',
      '1 week free featuring the agency',
      '{promotionCoupons} promoted coupons of which {premiumCoupons} premium, {highlightedCoupons} highlighted and {featuredCoupons} featured per month',
      '{agentCoupons} agent coupons when creating agency',
      'Unlimited AI Message',
      'Unlimited AI Insights',
      'Unlimited AI image description',
      'Unlimited saved searches',
    ],
