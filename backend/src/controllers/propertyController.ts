...
export const createProperty = async (
  ...
  try {
    ...
    const ALLOWED_PROPERTY_FIELDS = [
      'propertyId', 'listingType', 'title', 'status', 'price', 'isNegotiable', 'priceType', 'pricePerSqm', 'originalPrice', 'priceIntervals',
...
export const updateProperty = async (
  ...
  try {
    ...
    const fieldsToUpdate = [
      'propertyId', 'status', 'title', 'price', 'isNegotiable', 'priceType', 'pricePerSqm', 'address', 'city', 'country',
      'beds', 'baths', 'livingRooms', 'sqft', 'yearBuilt', 'parking',
