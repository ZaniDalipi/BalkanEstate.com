...
export const defaultEmailConfigs = [
  // ===== TRANSACTIONAL EMAILS =====
  {
    ...
    variables: [
      ...
      { name: 'verificationUrl', description: 'Email verification URL', required: true, example: 'https://balkanestateai.com/verify-email?token=abc123' },
    ],
    isActive: true,
  },
  {
    ...
    variables: [
      { name: 'userName', description: 'User\'s name', required: true, example: 'John Doe' },
      { name: 'resetUrl', description: 'Password reset URL', required: true, example: 'https://balkanestateai.com/reset-password?token=abc123' },
    ],
    isActive: true,
  },
  {
    ...
    variables: [
      { name: 'userName', description: 'User\'s name', required: true, example: 'John Doe' },
      { name: 'frontendUrl', description: 'Frontend base URL', required: true, example: 'https://balkanestateai.com' },
    ],
    isActive: true,
  },
  ...
  // ===== NOTIFICATION EMAILS =====
  {
    ...
    variables: [
      ...
      { name: 'conversationUrl', description: 'URL to view the conversation', required: true, example: 'https://balkanestateai.com/inbox/123' },
    ],
    isActive: true,
  },
  {
    ...
    variables: [
      ...
      { name: 'inquiryUrl', description: 'URL to respond to inquiry', required: true, example: 'https://balkanestateai.com/inbox/123' },
    ],
    isActive: true,
  },
  ...
  // ===== ALERT EMAILS =====
  {
    ...
    variables: [
      ...
      { name: 'searchUrl', description: 'URL to view search results', required: true, example: 'https://balkanestateai.com/search?...' },
    ],
    isActive: true,
  },
  {
    ...
    variables: [
      ...
      { name: 'propertyUrl', description: 'URL to view property', required: true, example: 'https://balkanestateai.com/property/123' },
    ],
    isActive: true,
  },
